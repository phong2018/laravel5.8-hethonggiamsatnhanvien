...
; (function ($, window, document, undefined) {
    ...
    var pluginName = "jkeyboard",
        defaults = {
            layout: "english",
            selectable: ['english','tiengviet', 'numeric', 'symbolic'],
            input: $('#input'),
            customLayouts: {
                selectable: []
            },
    ...
    var layouts = {
        ...
        english: [
            ...
            ['numeric_switch','tiengivet_switch', 'layout_switch', 'space', 'return']
        ],
        tiengviet: [
            ...
            ['shift', 'backspace','character_switch','numeric_switch', 'layout_switch', 'space', 'return'],
        ...
        numeric: [
            ...
            ['character_switch', 'layout_switch','tiengivet_switch', 'space', 'return'],
        ],
        symbolic: [
            ['[', ']', '{', '}', '#', '%', '^', '*', '+', '='],
            ['_', '\\', '|', '~', '<', '>'],
