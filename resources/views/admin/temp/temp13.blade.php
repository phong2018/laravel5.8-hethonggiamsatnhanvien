...
<p><button class="btn btn-primary" id="btinmaunhanhoso" onclick="inmaunhanhoso()">In Mẫu</button><button class="btn btn-primary" id="xuatwordmaunhanhoso" onclick="xuatword('PhieuchuyenHoso-{{$MaHoSo}}')">Xuất File Word</button></p>

<div id="maunhanhoso" style="width:85%;margin:auto;">
<table style="width:100%;text-align:center;">
	<tbody>
		<tr>
			<td><strong>T&ecirc;n Cơ quan</strong><br />
			S&ocirc;́: &hellip;&hellip;&hellip;&hellip;&hellip;.
			<p>M&atilde; Hồ Sơ</p>

			<p><img id="barcode" src="{{$BarCode}}" /></p>
			</td>
			<td><strong>CỘNG H&Ograve;A X&Atilde; HỘI CHỦ NGHĨA VIỆT NAM<br />
...
<h1>PHIẾU CHUYỂN HỒ SƠ</h1>
</div>

<p>Bộ phận Tiếp nhận v&agrave; trả kết quả đ&atilde; nhận hồ sơ của &ocirc;ng (b&agrave;):....</p>
...
function xuatwordmaunhanhoso(){
	Export2Doc($("#maunhanhoso").html(),'maubiennhanhoso');
