                ...
                <div class="card-body">
                    <form  action="{{$data['action_store']}}" accept-charset="UTF-8" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="tinhtrangxuly_name" type="text" class="form-control{{ $errors->has('tinhtrangxuly_name') ? ' is-invalid' : '' }}" name="tinhtrangxuly_name" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10"> 
                                ...
                                <input id="tinhtrangxuly_color" type="color" class=" {{ $errors->has('tinhtrangxuly_color') ? ' is-invalid' : '' }}" name="tinhtrangxuly_color" required  value="#7FFF00" style="width:50px;padding:0px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="sort_order" type="number" class="form-control{{ $errors->has('sort_order') ? ' is-invalid' : '' }}" name="sort_order">
                         ...
                         <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input id="active" type="radio"  name="status" checked="checked" value="1">
