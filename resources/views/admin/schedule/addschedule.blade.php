                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('schedule.store')}}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="schedule_name" placeholder="Tên Lịch Làm việc" type="text" class="form-control{{ $errors->has('schedule_name') ? ' is-invalid' : '' }}" name="schedule_name" required>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                  <input type="time" value="07:00" id="schedule_morningStart" name="schedule_morningStart" class="form-control"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                  <input type="time" value="11:00" id="schedule_morningEnd" name="schedule_morningEnd" class="form-control"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                  <input type="time" value="13:00" id="schedule_afternoonStart" name="schedule_afternoonStart" class="form-control"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                  <input type="time" value="17:00" id="schedule_afternoonEnd" name="schedule_afternoonEnd" class="form-control"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                  <input type="time" value="19:00" id="schedule_eveningStart" name="schedule_eveningStart" class="form-control"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                  <input type="time" value="23:00" id="schedule_eveningEnd" name="schedule_eveningEnd" class="form-control"  required>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input id="active" type="radio"  name="schedule_isActived" checked="checked" value="1">
                                    </td> <td style="width:20px;">
                                    </td><td>
                                    <label for="inactive" class="col-form-label text-md-righ">{{ __('Tắt') }}  &nbsp</label>
                                    </td><td>
                                    <input id="inactive" type="radio"  name="schedule_isActived" value="0"> 
                                     </td></table>
