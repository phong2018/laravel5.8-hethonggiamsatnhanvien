            ...
            <div class="col-md-12 col-xs-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                          ...
                          <form  action="{{url('admin/topic', [$topic->topic_id])}}"   accept-charset="UTF-8" method="POST" enctype="multipart/form-data">    
                         ...
                         {{ method_field('PUT') }}{{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="topic_name" type="text" class="form-control{{ $errors->has('topic_name') ? ' is-invalid' : '' }}" name="topic_name" value="{{$topic->topic_name}}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea  id="topic_description" name="topic_description" class="form-control">  {{$topic->topic_description}} </textarea>
                                </div>
                            </div> 
                            <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="hidden" id="topic_thumb" class="form-control" value="{{$topic->topic_thumb}}" type="text" name="topic_thumb">
                              </div>
                              
                                <img id="holder" src="{{url('/')}}/public{{$topic->topic_thumb}}" style="margin-top:15px;max-height:100px;">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input id="active" type="radio"  name="topic_isActived" 
                                    <?php if($topic->topic_isActived==1) echo "checked";?>
                                     value="1">
                                    </td> <td style="width:20px;">
                                    </td><td>
                                    <label for="inactive" class="col-form-label text-md-righ">{{ __('Tắt') }}  &nbsp</label>
                                    </td><td>
                                    <input id="inactive" type="radio"  name="topic_isActived" 
                                    <?php if($topic->topic_isActived==0) echo "checked";?>
                                    value="0"> 
                                     </td></table>
...
<div class="col-md-6 col-lg-6 col-xs-6">
 <h4 style="margin-bottom: 0px;"><strong>Danh Sách Câu Hỏi</strong></h4>
</div>
<div class="col-md-6 col-lg-6 col-xs-6 padding0" style="padding-bottom: 10px;">
 <a href="{{ route('question.create')}}/{{$topic->topic_id}} " class="pull-right btn btn-primary">
    <span class="glyphicon glyphicon-plus-sign"></span> Tạo Mới Câu hỏi
    </a>
</div>
...
<strong>* Lưu ý:</strong> Sau khi đã làm khảo sát thì không được phép sửa câu hỏi. Nếu vẫn sửa thì các bài khảo sát chứa câu hỏi này sẽ bị xóa.
</div>
...
function delObj(id){
  var r = confirm('Bạn chắc chắn xóa Câu hỏi này?');
        if (r) {
          var urll="{{ url('admin/question') }}/"+id;
          ...
          $.ajaxSetup({headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }});
            $.ajax({
                ...
                success:function (data) {//alert("YES");//alert(data['success']);
                  ...
                  //window.location="{{ url('admin/question') }}";
                  window.location="{{ URL::to('admin/topic/' . $topic->topic_id. '/edit')}}";
                },
