                ...
                <div class="card-body">
                    ...
                    <form  action="{{$data['action_store']}}" accept-charset="UTF-8" method="POST" enctype="multipart/form-data">    
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="pos_name" type="text" class="form-control{{ $errors->has('pos_name') ? ' is-invalid' : '' }}" name="pos_name" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="pos_short" type="text" class="form-control{{ $errors->has('pos_short') ? ' is-invalid' : '' }}" name="pos_short" required>
