...
-- Date: Sun, 15 Dec 2019 19:42:27 +0700
...
-- Dumped table `backup` with 10 row(s)
--
...
SET autocommit=0;
INSERT INTO `gs_usersector` VALUES (3,87,17,1),(4,87,16,1),(5,89,17,1),(6,89,16,1),(19,27,20,1),(20,27,19,1),(21,27,6,1);
/*!40000 ALTER TABLE `gs_usersector` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `gs_usersector` with 7 row(s)
--
...
SET autocommit=0;
INSERT INTO `ks_device` VALUES (33,'Laptop M4800','7KEPJ','2019-10-27 00:00:00',2,1,NULL,9,NULL,NULL,NULL),(40,'M4800 - FxScreen','I3RAO','2019-10-31 00:00:00',2,1,NULL,31,NULL,NULL,NULL),(44,'Kiosk Qui Đức - FXS','N67YJ','2019-10-31 00:00:00',2,1,NULL,31,NULL,NULL,NULL),(46,'Kiosk TLThuong FxScr','JHPXP','2019-11-02 00:00:00',2,1,NULL,36,NULL,NULL,NULL),(49,'Tablet Samsung 8 - Bình Chiểu - NTN DIỄM','K9GD4','2019-11-04 00:00:00',2,1,27,9,NULL,NULL,NULL),(51,'Tablet SS - Bình Chiểu - PT Trúc','7UB1J','2019-11-06 00:00:00',2,1,32,9,NULL,NULL,NULL),(53,'Tab - SS Bình Chiểu - ĐT Bình','7P1JO','2019-11-06 00:00:00',2,1,33,9,NULL,NULL,NULL),(55,'Tab ss Bình Chiểu - TTN Mai','2R80J','2019-11-06 00:00:00',2,1,42,9,NULL,NULL,NULL),(56,'Tab ss Bình chiểu - ĐM Đức','9FLC1','2019-11-06 00:00:00',2,1,31,9,NULL,NULL,NULL),(59,'Lenovo 7 inches - Test','8W9NU','2019-11-07 00:00:00',2,1,73,36,NULL,NULL,NULL),(61,'Kiosk Bình Chiểu FxScr','DK87Y','2019-11-07 00:00:00',2,1,NULL,9,NULL,NULL,NULL),(62,'Laptop - Thiện test','XEJ27','2019-11-07 00:00:00',2,1,NULL,9,NULL,NULL,NULL),(63,'Kiosk P2_BinhThanh FxScr','9Q7JA','2019-11-08 00:00:00',2,1,NULL,38,NULL,NULL,NULL),(74,'Kiosk P2 Bình Thạnh - No FxScr','RA922','2019-11-09 00:00:00',2,1,NULL,38,NULL,NULL,NULL),(77,'Thiết bị NC8ZE','NC8ZE','2019-11-11 00:00:00',2,1,NULL,9,NULL,NULL,NULL),(78,'Thiết bị WP83V','WP83V','2019-11-23 00:00:00',1,1,NULL,9,NULL,NULL,NULL),(79,'Thiết bị 2MCUW','2MCUW','2019-12-06 00:00:00',2,1,NULL,9,NULL,NULL,NULL);
/*!40000 ALTER TABLE `ks_device` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ks_device` with 17 row(s)
--
...
SET autocommit=0;
INSERT INTO `ks_organization` VALUES (9,'UBND PHƯỜNG BÌNH CHIỂU - QUẬN THỦ ĐỨC','/photos/1/QuochuyVN.png',1,5,2,0,16,'934 TL43, Bình Chiểu, Thủ Đức, Hồ Chí Minh','02838970030',1,1,NULL,NULL,NULL,NULL,NULL,9,0,0,NULL,NULL,NULL),(10,'Tiếp nhận - Trả kết quả','/photos/1/QuochuyVN.png',2,1,NULL,9,NULL,'934 TL43, Bình Chiểu, Thủ Đức, Hồ Chí Minh','102',0,1,1,NULL,NULL,NULL,NULL,9,10,2,NULL,NULL,NULL),(11,'Văn hóa - Xã hội','/photos/1/QuochuyVN.png',2,1,NULL,9,NULL,'934 TL43, Bình Chiểu, Thủ Đức, Hồ Chí Minh','103',0,1,0,NULL,NULL,NULL,NULL,9,11,3,NULL,NULL,NULL),(16,'Lãnh đạo UBND phường','/photos/1/QuochuyVN.png',2,1,2,9,NULL,'934 TL43, Bình Chiểu, Thủ Đức, Hồ Chí Minh','100',1,1,1,NULL,NULL,NULL,NULL,9,16,1,NULL,NULL,NULL),(30,'Kính tế - Đô thị','/photos/1/QuochuyVN.png',2,2,NULL,9,NULL,'934 TL43, Bình Chiểu, Thủ Đức, Hồ Chí Minh','104',1,1,NULL,NULL,NULL,2,'2019-11-18 15:05:53',9,30,4,NULL,NULL,NULL),(31,'ỦY BAN NHÂN DÂN XÃ QUI ĐỨC - BÌNH CHÁNH','/photos/1/QuochuyVN.png',1,1,NULL,0,16,'B3/24 ấp 2 Qui Đức, Huyện Bình Chánh, Tp. HCM','02837790197',1,1,1,NULL,NULL,NULL,NULL,31,0,0,NULL,NULL,NULL),(32,'Lãnh đạo UBND xã','/photos/1/QuochuyVN.png',2,50,NULL,31,NULL,'B3/24 ấp 2 Qui Đức, Huyện Bình Chánh, Tp. HCM','101',1,1,NULL,NULL,NULL,NULL,NULL,31,32,1,NULL,NULL,NULL),(33,'Tiếp nhận - Trả kết quả','/photos/1/QuochuyVN.png',2,1,NULL,31,NULL,'B3/24 ấp 2 Qui Đức, Huyện Bình Chánh, Tp. HCM','102',1,1,1,NULL,NULL,NULL,NULL,31,33,2,NULL,NULL,NULL),(34,'Văn hóa - Xã hội','/photos/1/QuochuyVN.png',2,1,NULL,31,NULL,'B3/24 ấp 2 Qui Đức, Huyện Bình Chánh, Tp. HCM','103',1,1,1,NULL,NULL,NULL,NULL,31,34,3,NULL,NULL,NULL),(35,'Kính tế - Đô thị','/photos/1/QuochuyVN.png',2,1,NULL,31,NULL,'B3/24 ấp 2 Qui Đức, Huyện Bình Chánh, Tp. HCM','104',1,1,1,NULL,NULL,NULL,NULL,31,35,4,NULL,NULL,NULL),(36,'UBND XÃ TRUNG LẬP THƯỢNG - HUYỆN CỦ CHI','/photos/1/QuochuyVN.png',1,1,NULL,0,16,'Trung Lập, Trung Lập Thượng, Củ Chi, Hồ Chí Minh','02838926786',1,1,1,NULL,NULL,NULL,NULL,36,0,0,NULL,NULL,NULL),(37,'Tiếp nhận và trả kết quả','/photos/1/QuochuyVN.png',2,1,NULL,36,NULL,'Trung Lập, Trung Lập Thượng, Củ Chi, Hồ Chí Minh','02838926786',1,1,1,NULL,NULL,NULL,NULL,36,37,1,NULL,NULL,NULL),(39,'BỆNH VIỆN ĐA KHOA HỒNG HÀ',NULL,1,1,NULL,0,26,'46 Phan Kính, Nam Hồng, Hồng Lĩnh, Hà Tĩnh','02393577678',NULL,1,1,NULL,NULL,NULL,NULL,39,0,1,NULL,NULL,NULL);
/*!40000 ALTER TABLE `ks_organization` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ks_organization` with 13 row(s)
--
...
SET autocommit=0;
INSERT INTO `ks_result` VALUES (1563,2189,53,'683',NULL,NULL,NULL),(1564,2189,60,'692',NULL,NULL,NULL),(1565,2189,61,'695',NULL,NULL,NULL);
/*!40000 ALTER TABLE `ks_result` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ks_result` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `sector` VALUES (1,'TƯ PHÁP',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(6,'THANH TRA',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(7,'GIÁO DỤC - ĐÀO TẠO',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(12,'LAO ĐỘNG THƯƠNG BINH & XÃ HỘI',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(14,'ĐỊA CHÍNH - TÀI NGUYÊN MÔI TRƯỜNG',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(15,'TÀI CHÍNH',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(16,'VĂN HÓA - THÔNG TIN',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(17,'NỘI VỤ',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(19,'CÔNG THƯƠNG',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1'),(20,'XÂY DỰNG',1,NULL,NULL,NULL,NULL,NULL,NULL,'1','1','1','1','1');
...
CREATE TABLE `setting` (
  ...
  KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=9787 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `setting` VALUES (4489,'config','config_meta_title','HỆ THỐNG QUẢN LÝ HỒ SƠ - ỦY BAN NHÂN PHƯỜNG LINH TRUNG',0),(4490,'config','config_logoadmin_qlp','/photos/1/logo.png',0),(4491,'config','config_logo_qlp','/photos/1/QuochuyVN.png',0),(4496,'config','config_meta_description','Hồ sơ 1 cửa phục vụ quản lý công việc tại Phường',0),(4497,'config','config_dossier_limit','10',0),(6511,'config','config_amthanhcamon','1569064487thank.wav',0),(6512,'config','config_amthanhxinchao','1569064487welcome.wav',0),(9666,'config','config_ks_meta_title','Hệ thống Giám Sát',0),(9668,'config','config_logoadmin_htks','/photos/1/QuochuyVN.png',0),(9670,'config','config_banner_htks','/photos/1/hoa-sen.png',0),(9672,'config','config_logo_htks','/photos/1/Chrysanthemum.jpg',0),(9682,'config','config_ks_meta_description','Hệ thống khảo sát hài lòng',0),(9684,'config','config_ks_intro_home_htks','<div style=\"background:#c73091;color:white;width:100%;padding:15px\">\r\n<h4><span style=\"font-size:28px;\">Ch&agrave;o mừng Qu&yacute; kh&aacute;ch đến với</span></h4>\r\n\r\n<h2><span style=\"font-size:48px;\">Hệ thống Đ&aacute;nh gi&aacute; Nh&acirc;n vi&ecirc;n</span></h2>\r\n\r\n<p><span style=\"font-size:24px;\">Đ&aacute;nh gi&aacute; n&agrave;y ho&agrave;n to&agrave;n bảo mật, d&ugrave;ng để chấm điểm thi đua&nbsp;v&agrave; v&ocirc; c&ugrave;ng&nbsp;c&oacute; &yacute; nghĩa trong cải thiện Chất lượng Dịch vụ của ch&uacute;ng t&ocirc;i.</span></p>\r\n</div>',0),(9686,'config','config_ks_thankyou_htks','<div style=\"background:#c73091;color:white;width:100%;padding:15px\">\r\n<h4><span style=\"font-size:48px;\">Ho&agrave;n tất Đ&aacute;nh gi&aacute;. </span></h4>\r\n\r\n<h4><span style=\"font-size:36px;\">Ch&uacute;ng t&ocirc;i ch&acirc;n th&agrave;nh cảm ơn qu&yacute; kh&aacute;ch!</span></h4>\r\n</div>',0),(9746,'config','config_gs_meta_title','HỆ THỐNG GIÁM SÁT',0),(9747,'config','config_gs_logoadmin','/photos/1/QuochuyVN.png',0),(9748,'config','config_gs_banner','/photos/1/bannerhome.png',0),(9749,'config','config_gs_logo',NULL,0),(9750,'config','config_tencoquan','UBND Quận Thủ Đức',0),(9751,'config','config_diachi','43 Nguyễn Văn Bá, Bình Thọ, Thủ Đức, Hồ Chí Minh',0),(9752,'config','config_sodienthoai','028 3896 6801',0),(9753,'config','config_emailcoquan','vp.thuduc@tphcm.gov.vn',0),(9754,'config','config_gs_meta_description','Hệ thống Giám sát',0),(9755,'config','config_gs_intro_home_htks','<p>Giới thiệu hệ thống</p>',0),(9756,'config','config_gs_thankyou_htks','<p>Trang Cảm ơn</p>',0),(9757,'config','config_dangkythietbidekhaosat','1',0),(9758,'config','config_showeverypage','10',0),(9759,'config','config_time_auto_direct','2',0),(9760,'config','config_gs_imgtype_allow','jpg;jpeg;png;gif;',0),(9761,'config','config_gs_imgsize_allow','10',0),(9762,'config','config_gs_videotype_allow','avi;mp4;3gp;wav;mov;',0),(9763,'config','config_gs_videosize_allow','20',0),(9764,'config','config_orgtosurvey',NULL,0),(9765,'config','config_bacode_symbology','qr',0),(9766,'config','config_barcode-width','100',0),(9767,'config','config_barcode-height','100',0),(9768,'config','config_barcode-padding','1',0),(9769,'config','config_temp_guiemail','10',0),(9770,'config','config_temp_guisms','11',0),(9771,'config','config_temp_biennhanhoso','12',0),(9772,'config','config_temp_chuyenhoso','13',0),(9773,'config','config_mail_protocol','smtp',0),(9774,'config','config_mail_parameter',NULL,0),(9775,'config','config_mail_smtp_hostname','smtp.gmail.com',0),(9776,'config','config_mail_smtp_username','nhakhoahoc.net@gmail.com',0),(9777,'config','config_mail_smtp_password','kzfimgzsaklzkwdb',0),(9778,'config','config_mail_smtp_port','587',0),(9779,'config','config_mail_encryption','tls',0),(9780,'config','config_mail_smtp_timeout','5',0),(9781,'config','config_sms_provider','esms.vn',0),(9782,'config','config_esmsvn_api_key','4E3E517F46E713FEC2F8AD8BE2D9D2',0),(9783,'config','config_esmsvn_secret_key','6C93319C7985AE7B2250B9042C10D6',0),(9784,'config','config_maintenance','0',0),(9785,'config','config_radiotimebackup','hourlyAt',0),(9786,'config','config_backup_time','hourlyAt,17,',0);
...
-- Dump completed on: Sun, 15 Dec 2019 19:42:28 +0700
