...
-- Date: Mon, 18 Nov 2019 16:54:58 +0700
...
-- Dumped table `backup` with 8 row(s)
--
...
SET autocommit=0;
INSERT INTO `gs_menu` VALUES (1,'Quản Lý Nhân Viên','Quản Lý Nhân Viên','<i class=\"fa fa-user fa-fw\"></i>',1,1,0,1,1,'user.index;user.create;user.store;user.edit;user.update;user.destroy;user.copy;',1),(2,'Quản lý Đơn vị','Quản lý đơn vị','<i class=\"fa fa-cubes\"></i>',1,1,0,1,1,'organization.index;organization.create;organization.store;organization.edit;organization.update;organization.destroy;',1);
/*!40000 ALTER TABLE `gs_menu` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `gs_menu` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `gs_menu_role` VALUES (3,1,2,1),(4,2,2,1);
/*!40000 ALTER TABLE `gs_menu_role` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `gs_menu_role` with 2 row(s)
--
...
-- Dumped table `gs_phananh` with 0 row(s)
--
...
-- Dumped table `gs_tinhtrangxuly` with 0 row(s)
--
...
CREATE TABLE `gs_xulyphananh` (
  ...
  KEY `xulyphananh_tinhtrangxulyphananh_id` (`tinhtrangxulyphananh_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dumped table `gs_xulyphananh` with 0 row(s)
--
...
CREATE TABLE `setting` (
  ...
  KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=8728 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `setting` VALUES (4489,'config','config_meta_title','HỆ THỐNG QUẢN LÝ HỒ SƠ - ỦY BAN NHÂN PHƯỜNG LINH TRUNG',0),(4490,'config','config_logoadmin_qlp','/photos/1/logo.png',0),(4491,'config','config_logo_qlp','/photos/1/QuochuyVN.png',0),(4496,'config','config_meta_description','Hồ sơ 1 cửa phục vụ quản lý công việc tại Phường',0),(4497,'config','config_dossier_limit','10',0),(6511,'config','config_amthanhcamon','1569064487thank.wav',0),(6512,'config','config_amthanhxinchao','1569064487welcome.wav',0),(8658,'config','config_ks_meta_title','Hệ thống Khảo sát sự hài lòng',0),(8660,'config','config_logoadmin_htks','/photos/1/QuochuyVN.png',0),(8662,'config','config_banner_htks','/photos/1/hoa-sen.png',0),(8664,'config','config_logo_htks','/photos/1/Chrysanthemum.jpg',0),(8666,'config','config_tencoquan','UBND Quận Thủ Đức',0),(8668,'config','config_diachi','43 Nguyễn Văn Bá, Bình Thọ, Thủ Đức, Hồ Chí Minh',0),(8670,'config','config_sodienthoai','028 3896 6801',0),(8672,'config','config_emailcoquan','vp.thuduc@tphcm.gov.vn',0),(8674,'config','config_ks_meta_description','Hệ thống khảo sát hài lòng',0),(8676,'config','config_ks_intro_home_htks','<div style=\"background:#c73091;color:white;width:100%;padding:15px\">\r\n<h4><span style=\"font-size:28px;\">Ch&agrave;o mừng Qu&yacute; kh&aacute;ch đến với</span></h4>\r\n\r\n<h2><span style=\"font-size:48px;\">Hệ thống Đ&aacute;nh gi&aacute; Nh&acirc;n vi&ecirc;n</span></h2>\r\n\r\n<p><span style=\"font-size:24px;\">Đ&aacute;nh gi&aacute; n&agrave;y ho&agrave;n to&agrave;n bảo mật, d&ugrave;ng để chấm điểm thi đua&nbsp;v&agrave; v&ocirc; c&ugrave;ng&nbsp;c&oacute; &yacute; nghĩa trong cải thiện Chất lượng Dịch vụ của ch&uacute;ng t&ocirc;i.</span></p>\r\n</div>',0),(8678,'config','config_ks_thankyou_htks','<div style=\"background:#c73091;color:white;width:100%;padding:15px\">\r\n<h4><span style=\"font-size:48px;\">Ho&agrave;n tất Đ&aacute;nh gi&aacute;. </span></h4>\r\n\r\n<h4><span style=\"font-size:36px;\">Ch&uacute;ng t&ocirc;i ch&acirc;n th&agrave;nh cảm ơn qu&yacute; kh&aacute;ch!</span></h4>\r\n</div>',0),(8680,'config','config_dangkythietbidekhaosat','1',0),(8682,'config','config_showeverypage','10',0),(8684,'config','config_time_auto_direct','10',0),(8686,'config','config_orgtosurvey',NULL,0),(8688,'config','config_bacode_symbology','qr',0),(8690,'config','config_barcode-width','100',0),(8692,'config','config_barcode-height','100',0),(8694,'config','config_barcode-padding','1',0),(8696,'config','config_temp_guiemail','10',0),(8698,'config','config_temp_guisms','11',0),(8700,'config','config_temp_biennhanhoso','12',0),(8702,'config','config_temp_chuyenhoso','13',0),(8704,'config','config_mail_protocol','smtp',0),(8706,'config','config_mail_parameter',NULL,0),(8708,'config','config_mail_smtp_hostname','smtp.gmail.com',0),(8710,'config','config_mail_smtp_username','nhakhoahoc.net@gmail.com',0),(8712,'config','config_mail_smtp_password','kzfimgzsaklzkwdb',0),(8714,'config','config_mail_smtp_port','587',0),(8716,'config','config_mail_encryption','tls',0),(8718,'config','config_mail_smtp_timeout','5',0),(8720,'config','config_sms_provider','esms.vn',0),(8722,'config','config_esmsvn_api_key','4E3E517F46E713FEC2F8AD8BE2D9D2',0),(8724,'config','config_esmsvn_secret_key','6C93319C7985AE7B2250B9042C10D6',0),(8725,'config','config_maintenance','0',0),(8726,'config','config_radiotimebackup','hourlyAt',0),(8727,'config','config_backup_time','hourlyAt,17,',0);
/*!40000 ALTER TABLE `setting` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `setting` with 44 row(s)
--
...
-- Dump completed on: Mon, 18 Nov 2019 16:54:58 +0700
